...
public final class SPUtils {
    ...
    //仅上传后用
    public static final String KEY_UPLOAD_USER_AVATAR = "key_upload_user_avatar";
    //APP获取眼镜运行初始参数下发到眼镜终端接口
    public static final String KEY_DEVICE_PARAM = "key_device_param";
    //简单保存未上传的训练数据
    public static final String KEY_SAVE_TRAINING_DATA = "key_save_training_data";
    //极光id
    public static final String KEY_USER_JPUSH_REGISTRATION_ID = "key_user_jpush_registration_id";
