...
public class DeviceMirror {
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(final BluetoothGatt gatt, final int status, final int newState) {
            ViseLog.e("onConnectionStateChange  status: " + status + " ,newState: " + newState +
            ...
            if (newState == BluetoothGatt.STATE_CONNECTED) {
                ...
                if (connectCallback != null) {
                    ...
                    ViseLog.e("onConnectionStateChange  status: " + status + " ,newState: " + newState +
                            "  ,removeDeviceMirror(deviceMirror): " + deviceMirror);
        ...
        public void onServicesDiscovered(final BluetoothGatt gatt, final int status) {
            ViseLog.e("onServicesDiscovered  status: " + status + "  ,thread: " + Thread.currentThread());
            if (handler != null) {
            ...
            if (status == 0) {
                ...
                if (connectCallback != null) {
                    ...
                    ViseLog.e("onServicesDiscovered  addDeviceMirror(deviceMirror) status: " + status + "  ,deviceMirror: " + deviceMirror);
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, final BluetoothGattCharacteristic characteristic, final int status) {
            ViseLog.e("onCharacteristicRead  status: " + status + ", data:" + HexUtil.encodeHexStr(characteristic.getValue()) +
                    "  ,thread: " + Thread.currentThread());
            if (status == BluetoothGatt.GATT_SUCCESS) {
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, final BluetoothGattCharacteristic characteristic, final int status) {
            ViseLog.e("onCharacteristicWrite  status: " + status + ", data:" + HexUtil.encodeHexStr(characteristic.getValue()) +
                    "  ,thread: " + Thread.currentThread());
            if (status == BluetoothGatt.GATT_SUCCESS) {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, final BluetoothGattCharacteristic characteristic) {
            ViseLog.e("onCharacteristicChanged data:" + HexUtil.encodeHexStr(characteristic.getValue()) +
                    "  ,thread: " + Thread.currentThread());
        ...
        public void onDescriptorRead(BluetoothGatt gatt, final BluetoothGattDescriptor descriptor, final int status) {
            ViseLog.e("onDescriptorRead  status: " + status + ", data:" + HexUtil.encodeHexStr(descriptor.getValue()) +
                    "  ,thread: " + Thread.currentThread());
            if (status == BluetoothGatt.GATT_SUCCESS) {
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, final BluetoothGattDescriptor descriptor, final int status) {
            ViseLog.e("onDescriptorWrite  status: " + status + ", data:" + HexUtil.encodeHexStr(descriptor.getValue()) +
                    "  ,thread: " + Thread.currentThread());
            if (status == BluetoothGatt.GATT_SUCCESS) {
    ...
    public void writeData(byte[] data) {
        ...
        if (!checkBluetoothGattInfo(writeInfoMap)) return;
