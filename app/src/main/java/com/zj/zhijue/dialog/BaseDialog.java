...
import com.zj.zhijue.callback.OnDialogClickListener;
import com.zj.zhijue.callback.SimpleOnKeyListener;
import com.zj.zhijue.helper.OnClickHelper;
...
public abstract class BaseDialog<D extends BaseDialog> extends Dialog implements View.OnClickListener {
     ...
     */
    public abstract void onCreateData(Context context);
