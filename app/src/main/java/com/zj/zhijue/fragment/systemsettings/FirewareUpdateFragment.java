 ...
 * 固件 更新
 */
public class FirewareUpdateFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_system_settings_firewareupdate_layout, container, false);
