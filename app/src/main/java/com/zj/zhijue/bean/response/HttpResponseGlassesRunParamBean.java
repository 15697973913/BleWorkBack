...
/**
 * 从云端接收到运行参数，发送给眼镜的bean ，需要拆分成四个 Bean 对象， Param1 - Param4 Bean 按照顺序发送给眼镜
 */
@Keep
public class HttpResponseGlassesRunParamBean {
    ...
    private int minMinusInterval;//2字节
    private int minPlusInterval;//2字节
    private int commonNumber;//1字节
    private int interveneAccMinute;//2字节
    private int weekKeyFre;//1字节
    private int weekAccMinute;//2字节
    private int backWeekAccMinute0;//2字节
    private int backWeekAccMinute1;//2字节
    private int backWeekAccMinute2;//2字节 //将该值分成高位和低位，分别装到 Param1 和 Param2 中. Param1 装低位， Param2 装高位

    /**
     *  Param 2
     */
    private int backWeekAccMinute3;//2字节
    private int plusInterval;//2字节
    private int minusInterval;//2字节
    private int plusInc;//1字节
    private int minusInc;//1字节
    private int incPer;//1字节
    private int runNumber;//1字节
    private int runSpeed;//1字节
    private int speedInc;//1字节
    private int speedSegment;//1字节
    private int intervalSegment;//1字节

    /**
     *  Param 3
     */

    private int backSpeedSegment;//1字节
    private int backIntervalSegment;//1字节
    private int speedKeyFre;//1字节
    private int interveneKeyFre;//1字节
    private int intervalAccMinute;//2字节
    private int minusInterval2;//2字节
    private int plusInterval2;//2字节
    private int minusInc2;//1字节
    private int plusInc2;//1字节
    private int incPer2;//1字节
    private int runNumber2;//1字节
    private int runSpeed2;//1字节

    /**
     *  Param 4
     */

    private int speedSegment2;//1字节
    private int speedInc2;//1字节
    private int intervalSegment2;//1字节
    private int backSpeedSegment2;//1字节
    private int backIntervalSegment2;//1字节
    private int speedKeyFre2;//1字节
    private int interveneKeyFre2;//1字节
    private int intervalAccMinute2;//2字节
    private int trainingState;//一字节
    private int trainingState2;//一字节
    ...
    public void setUserCode(long currentUserCode) {
