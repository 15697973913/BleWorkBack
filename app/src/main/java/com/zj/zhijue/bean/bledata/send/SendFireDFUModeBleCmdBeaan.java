 ...
 *  进入烧录固件升级 DFU 模式
 */
public class SendFireDFUModeBleCmdBeaan extends BaseCmdBean {
    ...
    protected String[] sendGlassesIntoFireCodeModeBleDataArray = {"a5", "51", "50", "00", "00",
            "00", "00", "00", "00", "00",
            "00", "00", "00", "00", "00",
            "00", "00", "00", "00", "aa"};

    public static final String GLASSES_INTO_DFU__MODE = "a55150";
