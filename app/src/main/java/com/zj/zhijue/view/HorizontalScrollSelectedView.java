...
public class HorizontalScrollSelectedView extends View {
    ...
    private TittleChangeListener tittleChangeListener;
    ...
    public HorizontalScrollSelectedView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorizontalScrollSelectedView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(AttributeSet attrs) {
        TintTypedArray tta = TintTypedArray.obtainStyledAttributes(getContext(), attrs,
                R.styleable.HorizontalScrollSelectedView);
        //两种字体颜色和字体大小
        seeSize = tta.getInteger(R.styleable.HorizontalScrollSelectedView_HorizontalselectedViewSeesize, 5);
        selectedTextSize = tta.getDimension(R.styleable.HorizontalScrollSelectedView_HorizontalselectedViewSelectedTextSize, 50);
        selectedColor = tta.getColor(R.styleable.HorizontalScrollSelectedView_HorizontalselectedViewSelectedTextColor, context.getResources().getColor(android.R.color.black));
        textSize = tta.getDimension(R.styleable.HorizontalScrollSelectedView_HorizontalselectedViewTextSize, 40);
        textColor = tta.getColor(R.styleable.HorizontalScrollSelectedView_HorizontalselectedViewTextColor, context.getResources().getColor(android.R.color.darker_gray));
    }
    ...
    private void notifyTittleIndexChange(int index) {
        if (null != tittleChangeListener) {
            tittleChangeListener.selectedIndexChanged(index);
        }
    }
    ...
    public void setTittleChangeListener(TittleChangeListener tittleChangeListener) {
        this.tittleChangeListener = tittleChangeListener;
    }
}
