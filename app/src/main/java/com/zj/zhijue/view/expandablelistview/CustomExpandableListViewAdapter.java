package com.zj.zhijue.view.expandablelistview;
...
public class CustomExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    // 定义一个List来保存列表数据
    private ArrayList<FatherDataBean> data_list = new ArrayList<>();

    // 定义一个构造方法
    public CustomExpandableListViewAdapter(Context context, ArrayList<FatherDataBean> datas) {
    ...
    // 刷新数据
    public void flashData(ArrayList<FatherDataBean> datas) {
        this.data_list = datas;
    ...
    public View getGroupView(int arg0, boolean arg1, View arg2, ViewGroup arg3) {
        ...
        if (arg2 == null) {
            ...
            hodlerViewFather.indexTextView = arg2.findViewById(R.id.problemindextv);
            hodlerViewFather.titlev = arg2.findViewById(R.id.alarm_clock_father_tv);
        ...
        if (arg1) {
            hodlerViewFather.group_state.setImageResource(R.drawable.shang);
        } else {
            hodlerViewFather.group_state.setImageResource(R.drawable.xia);
        }
        /**
         * 设置相应控件的内容
         */
        ...
        hodlerViewFather.indexTextView.setText("Q" + String.valueOf(arg0 + 1));
