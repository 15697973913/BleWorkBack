package com.zj.zhijue.view.videoplayview;
...
public class CommonVideoView extends FrameLayout implements MediaPlayer.OnPreparedListener,
    ...
    private OnStopPlayBackLisntener onStopPlayBackListener;
    ...
    public void setOnStopPlayBackListener(OnStopPlayBackLisntener onStopPlayBackListener) {
        this.onStopPlayBackListener = onStopPlayBackListener;
    }

    public interface OnStopPlayBackLisntener {
        void onStopPlayBack();
    }

    public void setNormalScreen() {
        if (onStopPlayBackListener != null) {
            onStopPlayBackListener.onStopPlayBack();
        }
        /*touchStatusImg.setImageResource(R.mipmap-xhdpi.iconfont_enter_32);
    ...
    private void initView() {
        ...
        touchStatusImg.setOnClickListener(this);
